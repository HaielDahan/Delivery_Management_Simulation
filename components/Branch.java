...
public class Branch implements Node, Runnable, Cloneable
{
	...
	/**
	 * A function that resets static variables
	 */
	public static void resetStaticBranch() { counter = 0; }
	
	
	public Object clone()
	{
		Branch cloneBranch = new Branch();
		
		for (Truck t : this.listTrucks)
		{
			cloneBranch.listTrucks.add((Truck)t.clone());
		}
